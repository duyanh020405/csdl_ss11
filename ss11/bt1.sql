...
select EmployeeID  , FullName  , Position  , Salary from Employees ;

-- 3
create view HighSalaryEmployees as 
select EmployeeID  , FullName  , Position  , Salary  from Employees where  salary >= 15000000 with check option ;
...
-- 5
drop view EmployeeBranch ;
alter table Employees
add column PhoneNumber varchar(20);
create view EmployeeBranch as  
select EmployeeID  , FullName  , Position  , Salary , PhoneNumber  from Employees ;

SET SQL_SAFE_UPDATES = 0;

delete from Branch where BranchName = 'Chi nhánh Hà Nội';
